...
public class CompressedCraftingTableBlockEntity extends RandomizableContainerBlockEntity implements CraftingContainer {
    ...
    public CompressedCraftingTableBlockEntity(BlockPos pPos, BlockState pState) {
    ...
    protected AbstractContainerMenu createMenu(int pContainerId, Inventory pInventory) {
        return new CompressedCraftingMenu(pContainerId, pInventory, ContainerLevelAccess.create(this.getLevel(), this.getBlockPos()));
    }
    ...
    public static void serverTick(Level pLevel, BlockPos pPos, BlockState pState, CompressedCraftingTableBlockEntity pCrafter) {
